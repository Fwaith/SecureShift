...
from accounts.views import demote_user, login, logout, promote_user, register, update_user, verify_otp, users_list, users_me
...
urlpatterns = [
    ...
    path('api1/v1/users/<int:user_id>/promote', promote_user, name='promote_user'),
    path('api1/v1/users/<int:user_id>/demote', demote_user, name='demote_user'),
